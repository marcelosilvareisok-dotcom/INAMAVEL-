...
export default function ShareModal({ isOpen, onClose, projectUrl, projectName }: ShareModalProps) {
  ...
  const handleWhatsAppShare = () => {
    const url = `https://wa.me/?text=${encodeURIComponent(shareText + ' ' + projectUrl)}`;
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <button
                  ...
                  className="flex items-center justify-center gap-2 py-3 px-4 bg-[#25D366]/10 text-[#25D366] hover:bg-[#25D366]/20 rounded-xl transition-colors text-sm font-medium"
                >
